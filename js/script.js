...
const config = {
    serverInfo: {
        ...
        serverName: "akramc", /*Server name*/
        serverIp: "play.akramc.eu", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
